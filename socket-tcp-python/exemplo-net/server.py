...
SERVER_IP = socket.gethostbyname(socket.gethostname())  #pega ip local
PORT = 5050  #porta selecionada
ADDR = (SERVER_IP, PORT) # endereço ip e porta
FORMATO = 'utf-8' 

server = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #servidor
server.bind(ADDR)
