...
def main():
	...
	msg_inicial = "1"  #Identificador do tipo 1 
	...
	######### MENU INICIAL CLIENTE TERMÔMETRO
	print()
	...
	print("2 - Enviar valor do termometro")
	...
	while cmd != '\x18':
		...
		if int(cmd) == 2:
			...
			print("Escolha o ambiente que vai enviar a temperatura")
			dispositivo = 0 #por causa do indice da lista  
			ambiente = input("ID: ")
			ambiente = int(ambiente)
			valor = input("Valor do termometro: ")
